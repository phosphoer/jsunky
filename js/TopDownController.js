...
TomatoJS.TopDownController = function(parent)
{
  this.parent = parent;
  this.speed = 80;
}

TomatoJS.TopDownController.prototype.Initialize = function()
{
  TomatoJS.Core.AddEventListener("OnFrameBegin", this);
}

TomatoJS.TopDownController.prototype.Uninitialize = function()
{
  TomatoJS.Core.RemoveEventListener("OnFrameBegin", this);
}

TomatoJS.TopDownController.prototype.OnFrameBegin = function(dt)
{
